import os
import Plot_3x3_plots

inputDir = input("Select the Segmentation folder: ")
Plot_3x3_plots(inputDir, ['normal_walk_1_0-6'], ['left'], 'Walking 0.6 m/s', 1)
# Plot_3x3_plots(inputDir, ['normal_walk_1_1-2'], ['left'], 'Walking 1.2 m/s', 1)
# Plot_3x3_plots(inputDir, ['normal_walk_1_1-8'], ['left'], 'Walking 1.8 m/s', 1)
...
# # Inclines
# Plot_3x3_plots(inputDir, ['incline_walk_1_up5'], ['left'], '5° Incline 1.2 m/s', 1)
# Plot_3x3_plots(inputDir, ['incline_walk_1_down5'], ['right'], '5° Decline 1.2 m/s', 1)
# Plot_3x3_plots(inputDir, ['incline_walk_2_up10'], ['left'], '10° Incline 1.2 m/s', 1)
# Plot_3x3_plots(inputDir, ['incline_walk_2_down10'], ['right'], '10° Decline 1.2 m/s', 1)
...
# Plot_3x3_plots(inputDir, ['jump_2_180', 'jump_2_180'], ['right', 'left'], '180° Jumps', 1)
# Plot_3x3_plots(inputDir, ['jump_2_lateral', 'jump_2_lateral'], ['right', 'left'], 'Lateral Jumps', 1)

# Plot_3x3_plots(inputDir, ['jump_3_90-1_segmented_backward', 'jump_3_90-1_segmented_forward'], ['left', 'right'], '90° Jumps (Leading Leg)', 1)
# Plot_3x3_plots(inputDir, ['jump_3_90-1_segmented_backward', 'jump_3_90-1_segmented_forward'], ['right', 'left'], '90° Jumps (Trailing Leg)', 1)

# Plot_3x3_plots(inputDir, ['jump_3_90-2_segmented_left', 'jump_3_90-2_segmented_left', 'jump_3_90-2_segmented_right', 'jump_3_90-2_segmented_right'], ['right', 'left', 'right', 'left'], '90° Lateral Jumps', 1)
